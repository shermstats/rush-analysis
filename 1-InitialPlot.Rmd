...
In this analysis, we want to understand what musical features
differentiate the various recording periods of Rush.

We've already downloaded the relevant data and munged it into tibbles
thanks to the wonderful `spotifyr` package.  Now that we have the data, 
let's do some cleanup.  I suspect we'll see some duplicate albums and 
will have to remove some features.
...
an album.  The title track of 2112 should not be weighted the same as 
